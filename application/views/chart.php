    ...
    <aside class="aside aside-fixed">
      ...
      <div class="aside-body">
        ...
        <ul class="nav nav-aside">
          ...
          <li class="nav-item active"><a href="<?php echo base_url(); ?>Chart" class="nav-link"><i data-feather="shopping-bag"></i> <span>PKU Chart</span></a></li>
          <li class="nav-item"><a href="dashboard-two.html" class="nav-link"><i data-feather="globe"></i> <span>PKU Tree</span></a></li>
          <li class="nav-item"><a href="dashboard-three.html" class="nav-link"><i data-feather="pie-chart"></i> <span>List Equipment</span></a></li>
          <li class="nav-item"><a href="dashboard-four.html" class="nav-link"><i data-feather="life-buoy"></i> <span>List WO</span></a></li>
      </div>
    </aside>
